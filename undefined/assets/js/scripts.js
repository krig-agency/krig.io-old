...
// eslint-disable-line
__webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"jquery-scrollify\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

document.addEventListener('DOMContentLoaded', function () {
  var bg = new _Background2.default(document.getElementById('nokey'));
  bg.startAnimation();
});
...
var Background = function () {
  function Background(canvasElement) {
    ...
    this.canvas.addEventListener('mousemove', function (event) {
      _this.mousePoint.pos.X = event.pageX;
      _this.mousePoint.pos.Y = event.pageY;
    });
  }
